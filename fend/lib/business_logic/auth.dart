...
class Auth {
  ...
  Future registration(String name, String emailAddress, String password, context) async {
    ...
    try {
      ...
      if (authCredential!.uid.isNotEmpty) {
        ...
        Navigator.of(context).pushNamed(RouteManager.buttonNviBar);
      } else {
  ...
  Future signOut(context) async {
    ...
    try {
      await _auth.signOut().then((value) {
        //Get.toNamed(signIn);
        Navigator.of(context).pushNamed(RouteManager.logindPage);
      });
    } catch (e) {
      print(e);
    }
